		...
		methods:{
			...
			gotoAddAddress(){
				if(this.$route.query.dzgl && this.$route.query.dzgl == 'grzx'){
					...
					this.$router.push({path:"/newAddress",query:{"openId":this.$route.query.openId,"orderDbId":this.$route.query.orderDbId,"userDbId":localStorage.getItem("userDbId")}})
			...
			editorAddress(params){
				if(this.$route.query.dzgl && this.$route.query.dzgl == 'grzx'){
					...
					this.$router.push( { path : "/newAddress", query : { "dbId" : params.dbId, "openId" : this.$route.query.openId, "orderDbId" : this.$route.query.orderDbId, "userDbId" : localStorage.getItem("userDbId") } } )
