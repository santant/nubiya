<template>
	<div id="user">
				...
				<li >
					<a href="tel:400-6690-999">
						<div>
							 <i class="icon iconfont">&#xe798;</i>
						 	 <p>客服电话</p>
						 	 <a style="color: #333; float: left; margin-left: 0.88rem;font-size: 0.77rem;" class="coun" >400-6690-999</a>
						 	 <!--<p>400-6690-999</p>-->
						</div>
					</a>
				</li>
		...
		<!--<ul class="userList">
=======
		<a class="telePhone" href="tel:400-6690-999">客服电话：400-6690-999</a>
		<ul class="userList">
>>>>>>> 32190432eb6bf28f6099168ac7c66dad85f0ca47
			<li>
				<router-link to="cart">
